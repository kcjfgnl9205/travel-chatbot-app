 ...
 *
 * ⚠️ **좌표는 쓰지 않는다.** 스키마에 lat/lng 를 넣으면 모델이 채워주긴 하는데,
 *    LLM 의 좌표는 그럴듯하고 자주 틀린다. 엉뚱한 곳에 핀이 꽂히는 건 이름으로
 ...
 */
export function mapsUrl(name: string, cityName?: string | null): string {
